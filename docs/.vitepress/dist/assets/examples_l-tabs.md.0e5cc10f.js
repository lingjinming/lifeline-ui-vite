import{a2 as d,_ as m,D as y,o as g,c as E,G as i,B as u,z as l,a as s,O as h}from"./chunks/framework.159a48cb.js";const{defineComponent:x}=d,A=x({name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:n,createVNode:e,Fragment:a,openBlock:o,createElementBlock:c}=d;function r(t,p){const C=n("l-button"),D=n("l-tabs");return o(),c(a,null,[e(C,{style:{"margin-bottom":"20px"},name:"切换tab选中",onClick:t.toggleGap},null,8,["onClick"]),e(D,{"data-theme":"light",modelValue:t.activeName,"onUpdate:modelValue":p[0]||(p[0]=b=>t.activeName=b),tabs:t.tabs,gap:0,onTabClick:t.handleClick},null,8,["modelValue","tabs","onTabClick"]),e(D,{"data-theme":"dark",modelValue:t.activeName,tabs:t.tabs,gap:20,clickable:!1,onTabClick:t.handleClick},null,8,["modelValue","tabs","onTabClick"])],64)}return{render:r,...{data(){return{gap:0,activeName:"",tabs:[{label:"nestjs",params:{key1:"val1"}},{label:0,subTit:0,params:{key2:"val2"}},{label:"nestjs3",subTit:"nestjs",img:"https://www.nestjs.com.cn/img/logo.png",params:{key1:"val1",key2:"val2"}}]}},methods:{handleClick(t){console.log(t)},toggleGap(){this.activeName="nestjs3"}}}}}()}}),T=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"examples/l-tabs.md","filePath":"examples/l-tabs.md","lastUpdated":1686539979000}');const k=l("h2",{id:"ltabs-用法",tabindex:"-1"},[s("LTabs 用法 "),l("a",{class:"header-anchor",href:"#ltabs-用法","aria-label":'Permalink to "LTabs 用法"'},"​")],-1),v=l("p",null,"可显示副标题和图片的 tabs,配置 data-theme 更换皮肤",-1),B=l("div",{class:"language-vue"},[l("pre",{"v-pre":"",class:"shiki material-theme-palenight"},[l("code",null,[l("span",{class:"line"},[l("span",{style:{color:"#89DDFF"}},"<"),l("span",{style:{color:"#F07178"}},"template"),l("span",{style:{color:"#89DDFF"}},">")]),s(`
...
`},{highlight:u(()=>[B]),default:u(()=>[i(F)]),_:1}),_])}const V=m(A,[["render",f]]);export{T as __pageData,V as default};
