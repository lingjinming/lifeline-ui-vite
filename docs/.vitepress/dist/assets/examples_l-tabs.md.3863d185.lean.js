import{a2 as d,_ as b,D as y,o as m,c as h,G as i,B as u,z as s,a as l,O as E}from"./chunks/framework.159a48cb.js";const{defineComponent:A}=d,x=A({name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:a,createVNode:e,Fragment:o,openBlock:n,createElementBlock:c}=d;function r(t,F){const C=a("l-button"),D=a("l-tabs");return n(),c(o,null,[e(C,{style:{"margin-bottom":"20px"},name:"切换tab间隔和选中",onClick:t.toggleGap},null,8,["onClick"]),e(D,{modelValue:t.activeName,"onUpdate:modelValue":F[0]||(F[0]=g=>t.activeName=g),tabs:t.tabs,gap:t.gap,onTabClick:t.handleClick},null,8,["modelValue","tabs","gap","onTabClick"]),e(D,{modelValue:t.activeName,tabs:t.tabs,gap:t.gap,"data-theme":"dark",onTabClick:t.handleClick},null,8,["modelValue","tabs","gap","onTabClick"])],64)}return{render:r,...{data(){return{gap:0,activeName:"",tabs:[{label:"nestjs",params:{key1:"val1"}},{label:"nestjs2",subTit:"nestjs",params:{key2:"val2"}},{label:"nestjs3",subTit:"nestjs",img:"https://www.nestjs.com.cn/img/logo.png",params:{key1:"val1",key2:"val2"}}]}},methods:{handleClick(t){console.log(t)},toggleGap(){this.activeName="nestjs3",this.gap?this.gap=0:this.gap=20}}}}}()}}),N=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"examples/l-tabs.md","filePath":"examples/l-tabs.md","lastUpdated":1685699586000}'),k=s("h2",{id:"ltabs-用法",tabindex:"-1"},[l("LTabs 用法 "),s("a",{class:"header-anchor",href:"#ltabs-用法","aria-label":'Permalink to "LTabs 用法"'},"​")],-1),v=s("p",null,"可显示副标题和图片的tabs",-1),B=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki material-theme-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"<"),s("span",{style:{color:"#F07178"}},"template"),s("span",{style:{color:"#89DDFF"}},">")]),l(`
...
<\/script>
`},{highlight:u(()=>[B]),default:u(()=>[i(p)]),_:1}),_])}const T=b(x,[["render",f]]);export{N as __pageData,T as default};
